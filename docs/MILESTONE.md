...
**기간**: 2026-01-28 (화) ~ 02-22 (일) | **예상 시간: 57.3시간** | **진행률: 24%**
...
### Week 2-3: 배포 자동화 (2026-02-09 ~ 02-22) 🔜 진행 예정

**주요 작업** (44시간):
1. **컨테이너화** (8시간)
   - Dockerfile Multi-stage Build, Docker Compose 구성
   - Nginx 리버스 프록시 + TLS 설정
2. **CI/CD 파이프라인** (9시간)
   - GitHub Actions (빌드, 테스트, 이미지 푸시)
   - Dependabot + Trivy 보안 스캔
3. **자동 배포** (10시간)
   - Watchtower 설정, Health Check, 롤백 전략
4. **모니터링** (10시간)
   - Portainer 대시보드, JSON 로그, MySQL 백업
5. **문서화** (7시간)
   - DEPLOYMENT.md, ADR-0020 (배포 자동화 전략)
...
| Phase 2: 배포 및 운영 인프라 | 2026-01-28 ~ 02-22 (3.5주) | 24% | 🚧 진행 중 |
